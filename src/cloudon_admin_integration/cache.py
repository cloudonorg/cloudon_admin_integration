        ...
        existing.update(
            {
                ...
                "application_id": kwargs.get("application_id") or existing.get("application_id"),
                "application_status": kwargs.get("application_status") or existing.get("application_status"),
                "application_expires_at": kwargs.get("application_expires_at") or existing.get("application_expires_at"),
